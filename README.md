...
<em>一套为内容创作者设计的 precision instrument。</em>
...
```
TryWorld Skills 是一个 skill 系统。
它不是工具集合。
它是内容生产链路。
```

五个 skill，按固定顺序衔接，形成一条从选题到交付的完整管线。
...
编号  名称                    功能                      状态
───────────────────────────────────────────────────────────
S01  tryworld-koubo-selection  选题筛选                   Stable
S02  tryworld-koubo-pipeline   口播总入口                 Stable
S03  tryworld-paper-algorithm  纸上算法视频               Stable
S04  tryworld-writer           公众号长文写作             Stable
S05  tryworld-hv-analysis      横纵分析深度研究           Stable
```

### S01 · tryworld-koubo-selection

**功能**：从 AIHOT 最新资讯中筛出值得做的选题。
